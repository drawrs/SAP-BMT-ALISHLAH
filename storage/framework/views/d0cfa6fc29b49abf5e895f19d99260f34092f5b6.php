  ...
  <div class="col-md-7 bordered col-md-offset-2">
    <table class="table table-borderless" width="" align="center">
      ...
      <tr>
        ...
        <td>
          <input type="text" class="clean inputable" name="tab5_margin_pb" value="<?php echo e($app->margin_pb); ?>">
          &nbsp;&nbsp;
      ...
      <tr>
        ...
        <td><input type="text" class="form-control inputable" name="tab5_angs_pb" value="<?php echo e($app->angs_pb); ?>"></td>
      </tr>
    ...
    <div class="col-md-6 bordered">
      <table class="table table-bordered table-responsive">
        <tr>
          ...
          <td>
            <input type="text" class="form-control inputable" value="<?php echo e($labaRugi->jml_angs); ?>" name="tab5_jml_angs">
          </td>
        </tr>
        <tr>
          <td>Laba / Rugi Bersih setelah angsuran</td>
          <td>
            <input type="text" class="form-control inputable"  value="<?php echo e($labaRugi->lb_rg); ?>" name="tab5_lb_rg">
          </td>
        </tr>
        <tr>
          <td>Income Coverage</td>
          <td>
            <input type="text" class="form-control inputable" value="<?php echo e($labaRugi->income); ?>"  name="tab5_income">
          </td>
        </tr>
      </table>
    </div>
